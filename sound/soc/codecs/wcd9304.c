...
#if defined(CONFIG_MACH_M4_UL) || defined(CONFIG_MACH_T6_UL) || defined(CONFIG_MACH_ZARA) || defined(CONFIG_MACH_OPERA_UL) || defined(CONFIG_MACH_DLXP) 
...
#if defined(CONFIG_MACH_M4_UL) || defined(CONFIG_MACH_ZARA) || defined(CONFIG_MACH_OPERA_UL)
